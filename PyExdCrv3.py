...
iExlFilename='Bv05jalLM_i'
# cExlFilename='v08_9mc'
cExlFilename='Bv05jalLM_c'
...
class Event:
    def __init__(self,study_folder_pv,scenario,weather,dc=None,jf=None,epf=None,lpf=None,exp=None,freq=None,x=None,y=None,rh = None, hole = None,holemm = None, PP = None, TT = None,fireball = None, dispersion = None, esd = True, bdv = True,module = None,deck= None):        
        ...
        if weather in weathers:
            ...
            if hole[0:2] in ['SM','ME','MA','LA']:
                ...
                if pv in Frequency.keys():                
                    ...
                    basefreq = Frequency[pv[:-3]][holesizeindex]
            elif hole[0:2] == "LM":
                for k in range(0,4):
                ...
                if pv in Frequency.keys():
                    ...
                    for k in range(holesizeindex,4):
                        basefreq += Frequency[pv[:-3]][k]
                        Frequency[pv[:-3]][k] = 0.
                    Frequency[pv[:-3]][holesizeindex] = basefreq
            ...
            aEvent = Event(study_folder_pv,hole,weather,freq=leak_freq,dc=Discharge(rr,duration,liqfrac=liqmassfrac),hole=Hole[key_hole],holemm = Holemm[key_hole],esd=esd,bdv=bdv,x=x,y=y,rh=z,PP=PP[pv],TT=TT[pv],module=Modules[pv],deck=Deck[pv])
...
for e in lEvent:    
    ...
    if MyOLFUnderstanding == True:
        ...
        e.PImdIgn *= (1-e.Discharge.LiquidMassFraction)
        e.PDelIgn *= (1-e.Discharge.LiquidMassFraction)
